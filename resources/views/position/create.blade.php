...
<body>
    <div class="container mt-5">
        <h2 class="text-center mt-10">{{ Auth::guard('company')->user()->name }} - New Position Especifications</h2>
            <div class="card mt-5">
                <div class="card-body">
                    <form method="POST" action="{{ route('position.store') }}" role="form"
                        ...
                        <div class="box box-info padding-1">
                            ...
                            <div class="form-group">
                                <label for="">Recruiter Designated</label>
