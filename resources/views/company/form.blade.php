<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('password') }}
            {{ Form::text('password', $company->password, ['class' => 'form-control' . ($errors->has('password') ? ' is-invalid' : ''), 'placeholder' => 'Password']) }}
    ...
    <div class="box-footer mt-2 mb-2">
        <a class="btn btn-sm btn-primary " href="{{ route('companies.index') }}">Back to Companies</a>
    </div>
</div>
